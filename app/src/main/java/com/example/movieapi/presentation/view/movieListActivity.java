...
import com.example.movieapi.domain.adapters.filtersAdapter.filterClickListener;
import com.example.movieapi.domain.adapters.filtersAdapter.filtersRecyclerViewAdapter;
import com.example.movieapi.domain.adapters.moviesAdapter.moviesRecyclerViewAdapter;
import com.example.movieapi.presentation.modelview.filtersViewModel;
import com.example.movieapi.presentation.modelview.movieListViewModel;

import java.util.List;

public class movieListActivity extends AppCompatActivity implements filterClickListener {
    private com.example.movieapi.presentation.modelview.movieListViewModel movieListViewModel;
    private RecyclerView moviesRecyclerView,filtersRecyclerView;
    private moviesRecyclerViewAdapter movieRecyclerViewAdapter;
    private com.example.movieapi.domain.adapters.filtersAdapter.filtersRecyclerViewAdapter filtersRecyclerViewAdapter;
    private com.example.movieapi.presentation.modelview.filtersViewModel filtersViewModel;
   private int page=1;
